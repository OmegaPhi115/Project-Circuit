...
def Game(row_count):
    screen_pos, map_circuit, map_bouton = location_calculs(row_count)
    # creation surface
    #todo trouver nom pour jeu
    pygame.display.set_caption('Project Circuit')
    window_game = pygame.display.set_mode(Window_taille, pygame.RESIZABLE)
    ...
    for circuit in circuit_list:
        ...
        circuit.placer()
    # creer screen
    seen = Screen(window_game, screen_pos[0], screen_pos[1])
